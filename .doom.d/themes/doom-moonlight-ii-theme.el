;;; doom-moonlight-ii-theme.el --- inspired by VS code's Moonlight -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup doom-moonlight-theme nil
  "Options for the `doom-moonlight-ii' theme."
  :group 'doom-themes)

(defcustom doom-moonlight-ii-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'doom-moonlight-ii-theme
  :type '(choice integer boolean))

;;
(def-doom-theme doom-moonlight-ii
  ...
  ((bg         '("#212337" "#212337"  "black"))
   ...
   (-modeline-pad
    (when doom-moonlight-ii-padded-modeline
...
;;; doom-moonlight-ii-theme.el ends here
