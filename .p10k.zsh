# Generated by Powerlevel10k configuration wizard on 2020-08-25 at 10:18 EDT.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 3838.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_{HOME,HOME_SUBFOLDER,ETC,DEFAULT}_FOREGROUND=cyan
